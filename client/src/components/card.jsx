    ...
    <div className='mt-[120px]'>
    {
        teacherarray.map((teacher)=>(
            ...
            onClick={ ()=>{
                ...
                axios .get(`http://localhost:3000/auth/getuserdata/${teacher._id}`)
                .then((response)=>{
                    console.log(response.data)
            ...
            className="max-w-xs mx-auto bg-red-500 text-white rounded-lg shadow-lg p-6 transform transition-all duration-500 ease-in-out 
            hover:scale-105 hover:shadow-2xl hover:bg-red-600 m-4">
